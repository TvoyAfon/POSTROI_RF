...
const CleaningCardDetailLeft: React.FC = () => {
	...
	const handleCreateOrder = () =>{
     nav(ROUTES_NAVBAR.createOrder)
		 dispatch(changeCategoryName(Categories.Cleaning))
	}

	return (
		<div className={styles['cardDetail_mainContent_leftSide']}>
			<img src={left_svg} alt="left_svg" />
		<div style={{...buttonPosition,top:100}}>	
			<Button
			onClick={handleCreateOrder}
				style={styleButtonOrange}>Создать заказ</Button>
			<Button
				style={styleButtonDark}>Просмотр исполнителей</Button></div>
...
export default CleaningCardDetailLeft
