...
const BuildExpertiseLeft: React.FC = () => {
	
	const dispatch = useDispatch()
	const nav = useNavigate()
	const handleCreateOrder = () =>{
     nav(ROUTES_NAVBAR.createOrder)
		 dispatch(changeCategoryName(Categories.BuildExpertise))
	}
	...
	return (
		<div className={styles['cardDetail_mainContent_leftSide']}>
			...
			<div style={{...buttonPosition,top:210}}>	
				<Button
				onClick={handleCreateOrder}
				style={styleButtonOrange}>Создать заказ</Button>
				<Button
					style={styleButtonDark}>Просмотр экспертов</Button></div>
			<div className={styles['cardDetail_mainContent_leftSide_content']}>
...
export default BuildExpertiseLeft
